...
export default function About() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
      <div className="bg-card rounded-xl p-6 sm:p-8 border border-border shadow-sm mb-6 sm:mb-8">
        <div className="flex flex-col md:flex-row gap-6 sm:gap-8 items-start">
          <div className="w-24 h-24 sm:w-32 sm:h-32 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0 mx-auto md:mx-0">
            <span className="text-4xl sm:text-5xl text-primary" style={{ fontWeight: 700 }}>
              D
            </span>
          </div>

          <div className="flex-1 text-center md:text-left">
            <h1 className="text-2xl sm:text-3xl text-foreground mb-2">개발자 이름</h1>
            <p className="text-lg sm:text-xl text-muted-foreground mb-4">Backend Developer</p>
      ...
      <div className="grid md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8">
        <div className="bg-card rounded-xl p-5 sm:p-6 border border-border shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg sm:text-xl text-foreground">경력</h2>
          </div>
        ...
        <div className="bg-card rounded-xl p-5 sm:p-6 border border-border shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg sm:text-xl text-foreground">학력</h2>
          </div>
          <div className="space-y-4">
            <div>
      ...
      <div className="bg-card rounded-xl p-6 sm:p-8 border border-border shadow-sm">
        <h2 className="text-xl sm:text-2xl text-foreground mb-4 sm:mb-6">기술 스택</h2>
        <div className="grid gap-4 sm:gap-6">
          {skills.map((skillGroup) => (
            <div key={skillGroup.category}>
              <h3 className="text-base sm:text-lg text-foreground mb-2 sm:mb-3">{skillGroup.category}</h3>
              <div className="flex flex-wrap gap-2">
                {skillGroup.items.map((skill) => (
                  <span
                    key={skill}
                    className="px-3 sm:px-4 py-1.5 sm:py-2 bg-primary/10 text-primary rounded-lg text-sm sm:text-base"
                  >
                    {skill}
                  </span>
                ))}
      ...
      <div className="mt-6 sm:mt-8 bg-accent/50 rounded-xl p-5 sm:p-6 border border-primary/20">
        <h2 className="text-lg sm:text-xl text-foreground mb-2 sm:mb-3">Dev Digest 소개</h2>
